  ...
  return (
    <nav className="bg-blue-900 text-white px-4 sm:px-8 py-4 shadow-md fixed top-0 left-0 w-full z-50">
      <div className="flex justify-between items-center relative">
        {/* Logo */}
        <Link to="/" className="text-2xl font-extrabold tracking-wide text-white flex-shrink-0">
        ...
        <ul className="hidden sm:flex gap-6 text-sm font-medium items-center ml-auto">
          {user?.role === "admin" && (
            <>
              <li><Link to="/admin/dashboard" className="hover:text-yellow-300">Dashboard</Link></li>
              <li><Link to="/admin/courses" className="hover:text-yellow-300">Courses</Link></li>
        ...
        <div className="hidden sm:flex items-center gap-4 ml-6">
          ...
          {user ? (
            <>
              ...
              />
              <span className="text-yellow-300 text-xs font-semibold uppercase">{user.role}</span>
              <button
        ...
        <ul className="sm:hidden absolute left-0 top-full w-full bg-blue-900 shadow-lg mt-0 py-4 px-6 space-y-3 text-sm font-medium z-40">
          {user?.role === "admin" && (
            <>
              ...
              <li><Link to="/admin/courses" onClick={() => setMenuOpen(false)}>Courses</Link></li>
